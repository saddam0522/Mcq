...
--
-- Host: localhost:3306
-- Generation Time: Jul 11, 2024 at 03:32 PM
...
CREATE TABLE `coupons` (
  ...
  `amount_type` int NOT NULL DEFAULT '1' COMMENT '1 = percentage, 2 = neat amount',
  ...
  `usage_per_user` int NOT NULL DEFAULT '0',
...
CREATE TABLE `exams` (
  ...
  `start_date` date DEFAULT NULL,
  `end_date` date DEFAULT NULL,
  `negative_marking` tinyint UNSIGNED NOT NULL DEFAULT '0' COMMENT '1 = yes, 0 = no',
  `reduce_mark` int UNSIGNED NOT NULL DEFAULT '0' COMMENT 'mark will be reduce for wrong answer',
  `pass_percentage` int UNSIGNED NOT NULL DEFAULT '0' COMMENT 'pass mark percentage for exam',
  `duration` int UNSIGNED NOT NULL DEFAULT '0' COMMENT 'exam duration time',
  `totalmark` int UNSIGNED NOT NULL DEFAULT '0' COMMENT 'exam total mark',
  `value` tinyint UNSIGNED NOT NULL DEFAULT '2' COMMENT '1=> paid, 2 => unpaid',
  `exam_fee` int UNSIGNED NOT NULL DEFAULT '0' COMMENT 'exam fee',
  `random_question` tinyint UNSIGNED NOT NULL DEFAULT '0' COMMENT 'questions will be random or not, 1=yes, 0= no',
  `option_suffle` tinyint UNSIGNED NOT NULL DEFAULT '0' COMMENT 'question options will be suffle or , not , 1 = yes, 0= no',
  `image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `results` (
  ...
  `total_correct_ans` int NOT NULL DEFAULT '0',
  `total_wrong_ans` int NOT NULL DEFAULT '0',
  `result_status` tinyint NOT NULL DEFAULT '2' COMMENT '1 = passed, 0 = failed, 2="attend"',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `written_previews` (
  ...
  `correct_ans` int NOT NULL DEFAULT '0' COMMENT '1 = prove correct ans, 0 = not provide\r\n',
  `status` bigint NOT NULL DEFAULT '0' COMMENT '1 = reviewed, 0 = not reviewed, "2" => ''attend''',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
