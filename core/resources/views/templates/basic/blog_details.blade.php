                ...
                <div class="col-xl-9 mb-30">
                    <div class="blog-item">
                        <div class="blog-thumb">
                            <img src="{{ frontendImage('blog', @$blog->data_values->cover_image, '970x510') }}"
                                alt="blog">
                        </div>
                                        ...
                                        <div class="single-popular-item d-flex flex-wrap align-items-center">
                                            ...
                                            <div class="popular-item-content">
                                                <a href="{{ route('blog.details', @$rb->slug) }}"
                                                    class="title">{{ Str::limit(@$rb->data_values->title, 20) }}</a>
                                                <span
                                                    class="blog-date">{{ showDateTime(@$rb->created_at, 'd M Y') }}</span>
                                            </div>
                                        </div>
                                    @endif
                                @endforeach
