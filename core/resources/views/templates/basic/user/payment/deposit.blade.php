...
@php
    if (Route::current()->getName() == 'user.deposit.index') {
        session()->forget('exam');
                                ...
                                <div class="payment-system-list p-3">
                                    <div class="deposit-info">
                                        ...
                                        <div class="deposit-info__input">
                                            <div
                                                class="deposit-info__input-group input-group {{ $price != null ? 'bg-light' : '' }}">
                                                ...
                                                <input type="text" class="form-control form--control amount"
                                                    ...
                                                    value="{{ $price != null ? getAmount($price) : old('amount') }}"
                                                    autocomplete="off" {{ $price != null ? 'readonly' : '' }}>
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
