...
@section('content')
    ...
    <div class="mt-30 @guest container mb-60 mt-60 @endguest">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card custom--card">
                    <div
                        class="card-header card-header-bg d-flex flex-wrap justify-content-between align-items-center bg--base">
