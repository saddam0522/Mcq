...
@section('panel')
    <div class="container-fluid">
        ...
        <form action="{{ route('admin.exam.manage.update', $exam->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="col-lg-6">
                                ...
                                <select class="form-control select2" data-minimum-results-for-search="-1" name="subject_id"
                                    ...
                                    @foreach ($subjects as $subject)
                                        <option value="{{ $subject->id }}"
                                            {{ $exam->subject_id == $subject->id ? 'selected' : '' }}>{{ $subject->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" data-minimum-results-for-search="-1"
                                    ...
                                    <option value="1" {{ $exam->question_type == 1 ? 'selected' : '' }}>
                                        @lang('MCQ')</option>
                                    <option value="2" {{ $exam->question_type == 2 ? 'selected' : '' }}>
                                        @lang('Written')</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input class="form-control" placeholder="@lang('Pass Mark Percentage eg: 33%')" type="text"
                                        name="pass_percentage" required value="{{ $exam->pass_percentage }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control value select2" data-minimum-results-for-search="-1"
                                    ...
                                    <option value="1" {{ $exam->value == 1 ? 'selected' : '' }}>@lang('Paid')
                                    </option>
                                    <option value="2" {{ $exam->value == 2 ? 'selected' : '' }}>@lang('Unpaid')
                                    </option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input class="form-control exam_fee" placeholder="@lang('Exam Fee')" type="text"
                                        name="exam_fee" required value="{{ getAmount($exam->exam_fee) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="start_date" class="datepicker-here form-control"
                                    ...
                                    placeholder="@lang('Start Date')" required value="{{ $exam->start_date }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="end_date" class="datepicker-here form-control"
                                    data-language='en' data-date-format="dd-mm-yyyy" data-position='top left'
                                    placeholder="@lang('End Date')" required value="{{ $exam->end_date }}">
                        ...
                        <div class="col-lg-6">
                                ...
                                <div class="image-upload">
                                    <div class="thumb">
                                        <div class="avatar-edit">
                                            <x-image-uploader image="{{ $exam->image }}" class="w-100"
                                                type="examThumbnail" :required=false />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="checkbox" class="neg_status removeEl" data-width="100%"
                                    ...
                                    @if ($exam->question_type == 2) disabled @endif
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control reduce" type="text" placeholder="@lang('Reduce Mark')"
                                    name="reduce_mark" @if ($exam->negative_marking == 0) disabled @endif
                                    value="{{ $exam->reduce_mark ?? '0' }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger"
                                    ...
                                    name="randomize" @if ($exam->random_question == 1) checked @endif>
                            </div>
                            <div class="form-group">
                                <label class="form-control-label font-weight-bold">@lang('Question options suffle (optional)') </label>
                                <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger"
                                    data-bs-toggle="toggle" data-on="@lang('ON')" data-off="@lang('OFF')"
                                    name="opt_suffle" @if ($exam->option_suffle == 1) checked @endif>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger"
                                    ...
                                    name="status" @if ($exam->status == 1) checked @endif>
                            </div>
                        </div>
