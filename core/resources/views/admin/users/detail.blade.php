        ...
        <div class="col-12">
            ...
            <div class="row gy-4">
                <div class="col-xxl-2 col-lg-4 col-sm-6">
                    <x-widget style="5" link="{{ route('admin.report.transaction', $user->id) }}" icon="las la-money-bill-wave-alt" title="Balance" value="{{ showAmount($user->balance) }}" bg="primary" />
                </div><!-- dashboard-w1 end -->
                <div class="col-xxl-2 col-lg-4 col-sm-6">
                    <x-widget style="5" link="" icon="las la-wallet" title="Deposits" value="{{ showAmount($totalDeposit) }}" bg="1" />
                </div><!-- dashboard-w1 end -->
                <div class="col-xxl-2 col-lg-4 col-sm-6">
                    <x-widget style="5" link="#" icon="las la-exchange-alt" title="Transactions" value="{{ $totalTransaction }}" bg="2" />
                </div><!-- dashboard-w1 end -->
                <div class="col-xxl-3 col-lg-6 col-sm-6">
                    <x-widget style="5" link="{{ route('admin.users.mcq.exams', $user->id) }}" icon="la la-book" title="Total Mcq Exam" value="{{ $user->results->count() }}" bg="3" />
                </div><!-- dashboard-w1 end -->
                <div class="col-xxl-3 col-lg-6 col-sm-6">
                    <x-widget style="5" link="{{ route('admin.users.written.exams', $user->id) }}" icon="la la-book" title="Total Written Exam" value="{{ $user->written->groupBy('exam_id')->count() }}" bg="4" />
                </div><!-- dashboard-w1 end -->
            </div><!-- row end-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-on="@lang('Verified')" data-off="@lang('Unverified')"
                            ...
                            <div class="col-xl-4 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" data-width="100%" data-height="50" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-on="@lang('Enable')"
