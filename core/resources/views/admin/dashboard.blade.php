...
@section('panel')
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.exam.manage.all') }}" title="Total Exam" icon="fas fa-book"
                value="{{ $widget['totalexam'] }}" bg="success" outline="true" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.exam.manage.all') }}" title="Total Mcq Exam" icon="fas fa-book"
                value="{{ $widget['totalMcqExam'] }}" bg="warning" outline="true" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.exam.manage.all') }}" title="Total Written Exam"
                icon="fas fa-book" value="{{ $widget['totalWrittenExam'] }}" bg="danger" outline="true" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.coupon.all') }}" title="Total Active Coupon" icon="fas fa-tags"
                value="{{ $widget['totalActiveCoupon'] }}" bg="primary" outline="true" />
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->
        ...
        <div class="col-xxl-6">
            <div class="row custom--row">
                            ...
                            <div class="widget-card-wrapper">
                                    ...
                                    <div class="widget-card-left">
                                        ...
                                        <div class="widget-card-content">
                                            <h6 class="widget-card-amount">
                                                {{ showAmount($deposit['total_deposit_amount']) }}</h6>
                                ...
                                <div class="widget-card bg--primary">
                                    ...
                                    <div class="widget-card-left">
                                        ...
                                        <div class="widget-card-content">
                                            <h6 class="widget-card-amount">
                                                {{ showAmount($deposit['total_deposit_charge']) }}</h6>
                ...
                <div class="col-12">
                    <div class="card box-shadow3">
                        <div class="card-body">
                            <h5 class="card-title">@lang('Misc')</h5>
                            <div class="widget-card-wrapper">
                                <div class="widget-card bg--success">
                                    <a href="{{ route('admin.exam.subjects') }}" class="widget-card-link"></a>
                                    <div class="widget-card-left">
                                        <div class="widget-card-icon">
                                        ...
                                        <div class="widget-card-content">
                                            <h6 class="widget-card-amount">
                                                {{ $widget['totalSubject'] }}</h6>
                                            <p class="widget-card-title">@lang('Total Subject')</p>
                                        </div>
                                    </div>
                                    <span class="widget-card-arrow">
                                        <i class="las la-angle-right"></i>
                                ...
                                <div class="widget-card bg--warning">
                                    <a href="{{ route('admin.exam.categories') }}" class="widget-card-link"></a>
                                    <div class="widget-card-left">
                                        <div class="widget-card-icon">
                                            <i class="fas fa-list"></i>
                                        </div>
                                        <div class="widget-card-content">
                                            <h6 class="widget-card-amount">{{ $widget['totalCategory'] }}</h6>
                                            <p class="widget-card-title">@lang('Total Category')</p>
                                        </div>
                                    </div>
                                    <span class="widget-card-arrow">
                                        <i class="las la-angle-right"></i>
                                ...
                                <div class="widget-card bg--danger">
                                    ...
                                    <div class="widget-card-left">
                                        ...
                                        <div class="widget-card-content">
                                            <h6 class="widget-card-amount">{{ $widget['totalPendingTicket'] }}</h6>
                                            <p class="widget-card-title">@lang('Total Pending Ticket')</p>
                                        </div>
                                    </div>
                                    <span class="widget-card-arrow">
                                        <i class="las la-angle-right"></i>
                                ...
                                <div class="widget-card bg--primary">
                                    <a href="{{ route('admin.subscriber.index') }}" class="widget-card-link"></a>
                                    <div class="widget-card-left">
                                        <div class="widget-card-icon">
                                            <i class="fas fa-thumbs-up"></i>
                                        </div>
                                        <div class="widget-card-content">
                                            <h6 class="widget-card-amount"> {{ $widget['totalSubscriber'] }}</h6>
                                            <p class="widget-card-title">@lang('Total Subscribers')</p>
                                        </div>
                                    </div>
                                    <span class="widget-card-arrow">
                                        <i class="las la-angle-right"></i>
