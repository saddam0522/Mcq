...
Route::middleware('admin')->group(function ()
{
    ...
    Route::controller('ManageUsersController')->name('users.')->prefix('users')->group(function ()
    {
        ...
        Route::get('user/exams/mcq/{id}', 'userMcqExam')->name('mcq.exams');
        Route::get('user/exams/written/{id}', 'userWrittenExam')->name('written.exams');
    });
    ...
    Route::name('exam.')->prefix('exam')->group(function ()
    {
        ...
        Route::controller('CategoryController')->name('categories.')->prefix('categories')->group(function ()
        {
            Route::get('index', 'allCategories')->name('index');
            Route::post('store', 'store')->name('store');
            Route::post('update/{id}', 'update')->name('update');
        });

        //exam subject manage
        Route::controller('SubjectController')->name('categories.')->prefix('categories')->group(function ()
        {
            Route::get('subjects', 'SubjectController@allsubject')->name('subjects');
    ...
    //exam manage
    Route::get('exam/all', 'ExamController@allExams')->name('exam.manage.all');
    Route::get('exam/add', 'ExamController@addExam')->name('exam.manage.add');
    Route::post('exam/store', 'ExamController@store')->name('exam.manage.store');
    Route::get('exam/edit/{id}', 'ExamController@editExam')->name('exam.manage.edit');
    Route::post('exam/update/{id}', 'ExamController@update')->name('exam.manage.update');
    //exam certificate
    ...
    Route::controller('WrittenReviewController')->name('written.')->prefix('written')->group(function ()
    {
        Route::get('pending/all', 'allPending')->name('pending.all');
        Route::get('pending/exams', 'pendingExam')->name('pending.exam');
        Route::get('pending/exam/details/{id}', 'pendingExamDetails')->name('pending.exam.details');
        Route::get('reviewed/exams', 'reviewedExam')->name('reviewed.exam');
        Route::get('reviewed/exam/details/{id}', 'reviewedExamDetails')->name('reviewed.exam.details');
        Route::get('details/{userid}/{qtnid}', 'writtenDetails')->name('details');
