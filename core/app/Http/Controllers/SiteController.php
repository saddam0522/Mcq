...
class SiteController extends Controller
{
    ...
    public function subjectExams($slug)
    {
        ...
        $pageTitle = "Exams of " . ucfirst($sub->name);
        return view('Template::exams', compact('pageTitle', 'exams'));
    }
    ...
    public function categorySubject($slug)
    {
        ...
        $pageTitle = "Subjects of $category->name";
        $subjects = Subject::where('category_id', $category->id)->where('status', Status::ACTIVE)->with('category')->paginate(9);
        return view('Template::subjects', compact('pageTitle', 'subjects'));
    }
    ...
    public function examDetails($id)
    {
        ...
        return view('Template::examDetails', compact('pageTitle', 'exam'));
    }
    ...
    public function blog()
    {
        ...
        return view('Template::blog', compact('pageTitle', 'blogElements'));
    }
    ...
    public function faq()
    {
        ...
        return view('Template::faq', compact('pageTitle', 'faqs'));
    }
}
