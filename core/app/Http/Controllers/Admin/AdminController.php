...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $widget['totalexam'] = Exam::where('status', 1)->count();
        $widget['totalMcqExam'] = Exam::where('status', 1)->where('question_type', 1)->count();
        $widget['totalWrittenExam'] = Exam::where('status', 1)->where('question_type', 2)->count();
        $widget['totalActiveCoupon'] = Coupon::where('status', 1)->count();

        $widget['totalSubject'] = Subject::where('status', 1)->count();
        $widget['totalCategory'] = Category::where('status', 1)->count();
        $widget['totalPendingTicket'] = SupportTicket::where('status', 0)->count();
        $widget['totalSubscriber'] = Subscriber::count();
