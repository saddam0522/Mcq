...
class ManageUsersController extends Controller
{
    ...
    public function userMcqExam(Request $request, $userid)
    {
        ...
        $histories = Result::where('user_id', $userid)->mcqQues()->searchable(['exam:title'])->paginate(15);

        return view('admin.users.userMcqExams', compact('pageTitle', 'histories', 'userid'));
    }
    ...
    public function userWrittenExam(Request $request, $userid)
    {
        ...
        $exams = Exam::whereIn('id', $examId)->searchable(['title'])->paginate(15);

        return view('admin.users.userWrittenExams', compact('pageTitle', 'exams', 'userid'));
    }
}
