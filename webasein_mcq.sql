...
--
-- Host: localhost:3306
-- Generation Time: Aug 09, 2025 at 08:56 AM
...
(1, 'Super Admins', 'hello@webase.com.bd', 'WebaseSolutions', NULL, '6624ee96387ea1713696406.png', '$2y$12$qcxT150ktPrslCt41hpC.e.Gfs5ZV2quas7cV0exWmQNUS.9ITVyK', NULL, NULL, '2025-07-18 16:13:36');
...
(1, 1, 'New member registered', 1, '/admin/users/detail/1', '2025-07-18 22:28:16', '2025-07-18 22:44:20'),
(2, 1, 'Payment completed for 45 BCS Exam Question exam', 1, '/admin/report/transaction', '2025-07-18 22:30:37', '2025-08-02 11:44:44'),
(3, 2, 'New member registered', 0, '/admin/users/detail/2', '2025-07-20 18:10:59', '2025-07-20 18:10:59'),
(4, 3, 'New member registered', 1, '/admin/users/detail/3', '2025-07-22 17:13:22', '2025-08-02 11:44:37');
...
CREATE TABLE `applications` (
  ...
  `status` enum('pending','reviewed','rejected','shortlisted') NOT NULL DEFAULT 'pending',
...
(1, 'BCS Preparation', 'bcs-preparation', 1, '2025-07-18 16:13:59', '2025-07-18 16:13:59'),
(2, 'Bank job mastering', 'bank-job-mastering', 1, '2025-07-18 23:23:47', '2025-07-18 23:23:47'),
(3, 'BCS Preliminary', 'bcs-preliminary', 1, '2025-07-26 17:49:16', '2025-07-26 17:49:16');
...
INSERT INTO `chapters` (`id`, `subject_id`, `name`, `slug`, `description`, `banner`, `status`, `created_at`, `updated_at`) VALUES
(1, 2, 'শব্দতত্ত্ব', NULL, NULL, NULL, 1, '2025-07-22 11:41:23', '2025-07-22 11:41:23'),
(2, 2, 'ভাষা', NULL, NULL, NULL, 1, '2025-07-26 17:52:06', '2025-07-26 17:52:06');
...
CREATE TABLE `employers` (
  ...
  `is_approved` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Admin approval status',
  ...
  `company_country` varchar(255) NOT NULL DEFAULT 'Bangladesh',
  `representative_name` varchar(255) NOT NULL,
  `representative_designation` varchar(255) DEFAULT NULL,
...
INSERT INTO `employers` (`id`, `email`, `user_name`, `password`, `email_verified_at`, `remember_token`, `is_approved`, `is_active`, `company_name`, `industry`, `website`, `logo`, `company_description`, `company_address`, `company_city`, `company_country`, `representative_name`, `representative_designation`, `representative_email`, `representative_phone`, `created_at`, `updated_at`) VALUES
(1, 'saddam.webase@gmail.com', NULL, '$2y$12$nkUMHRYf1Wx6oYFsLSGaNuOiH8PVzNZwVoupfjDqhuyChoq1wBulm', NULL, NULL, 0, 1, 'webase', NULL, NULL, NULL, NULL, NULL, NULL, 'Bangladesh', 'Saddam Hossain', NULL, NULL, NULL, '2025-08-09 11:19:48', '2025-08-09 11:19:48');
...
INSERT INTO `exams` (`id`, `subject_id`, `title`, `instruction`, `start_date`, `end_date`, `negative_marking`, `reduce_mark`, `pass_percentage`, `duration`, `totalmark`, `value`, `exam_fee`, `random_question`, `option_suffle`, `image`, `question_type`, `status`, `created_at`, `updated_at`) VALUES
(1, 1, '45 BCS Exam Question', '<br>', '2025-07-18', '2026-07-19', 1, 0, 33, 90, 200, 2, 0, 1, 1, '687a74aba245d1752855723.jpg', 1, 1, '2025-07-18 22:21:48', '2025-07-20 18:13:53'),
(2, 1, 'Bangla-1', '<br>', '2025-08-09', '2025-08-10', 1, 0, 33, 50, 50, 2, 0, 1, 1, NULL, 1, 1, '2025-08-05 21:51:04', '2025-08-05 21:51:04');
...
(81, 'contact.content', '{\"heading\":\"Get In Touch\",\"short_details\":\"Questions, bug reports, complaints, and compliments \\u2014 we\\u2019re here for it all. Our support team is ready to help you!\",\"address\":\"House 21, Road 03, Mohammadia Housing Society, Mohammadpur, Dhaka, Bangladesh\",\"email\":\"hello@webase.com.bd\",\"phone\":\"+8801812442234\",\"latitude\":\"23.76202575976612\",\"longitude\":\"90.35704284633727\"}', NULL, 'basic', '', '2021-03-21 07:19:08', '2025-07-18 22:35:21'),
(82, 'seo.data', '{\"seo_image\":\"1\",\"keywords\":[\"online exam\",\"exam\",\"mcq\",\"Online exams\",\"Certification exams\",\"Exam platform\",\"Student assessments\",\"Educational testing\",\"Virtual certificates\",\"jobcoachbd\",\"bcs\",\"pre-li\"],\"description\":\"JobCoachBD offers MCQ tests, job listening practice, and expert guidance to help you prepare smartly and succeed in govt and private job exams.\",\"social_title\":\"JobCoachBD - turns your efforts into offers.\",\"social_description\":\"JobCoachBD provides expert MCQ tests, job listening exercises, and career guidance to help you prepare smartly and land your dream job in government or private sectors.\",\"image\":\"687f5b6f9293f1753176943.png\"}', NULL, 'basic', '', '2021-04-21 02:01:23', '2025-07-22 16:12:04');
INSERT INTO `frontends` (`id`, `data_keys`, `data_values`, `seo_content`, `tempname`, `slug`, `created_at`, `updated_at`) VALUES
...
(90, 'blog.element', '{\"has_image\":[\"1\"],\"title\":\"Test\",\"body\":\"test\",\"cover_image\":\"6889f8802f7321753872512.png\"}', NULL, 'basic', 'test', '2025-07-30 16:48:32', '2025-07-30 16:48:32');
...
(25, 0, 114, 'Stripe Checkout', 'StripeV3', '663a39afb519f1715091887.png', 0, '{\"secret_key\":{\"title\":\"Secret Key\",\"global\":true,\"value\":\"sk_test_51I6GGiCGv1sRiQlEi5v1or9eR0HVbuzdMd2rW4n3DxC8UKfz66R4X6n4yYkzvI2LeAIuRU9H99ZpY7XCNFC9xMs500vBjZGkKG\"},\"publishable_key\":{\"title\":\"PUBLISHABLE KEY\",\"global\":true,\"value\":\"pk_test_51I6GGiCGv1sRiQlEOisPKrjBqQqqcFsw8mXNaZ2H2baN6R01NulFS7dKFji1NRRxuchoUTEDdB7ujKcyKYSVc0z500eth7otOM\"},\"end_point\":{\"title\":\"End Point Secret\",\"global\":true,\"value\":\"whsec_lUmit1gtxwKTveLnSe88xCSDdnPOt8g5\"}}', '{\"USD\":\"USD\",\"AUD\":\"AUD\",\"BRL\":\"BRL\",\"CAD\":\"CAD\",\"CHF\":\"CHF\",\"DKK\":\"DKK\",\"EUR\":\"EUR\",\"GBP\":\"GBP\",\"HKD\":\"HKD\",\"INR\":\"INR\",\"JPY\":\"JPY\",\"MXN\":\"MXN\",\"MYR\":\"MYR\",\"NOK\":\"NOK\",\"NZD\":\"NZD\",\"PLN\":\"PLN\",\"SEK\":\"SEK\",\"SGD\":\"SGD\"}', 0, '{\"webhook\":{\"title\": \"Webhook Endpoint\",\"value\":\"ipn.StripeV3\"}}', NULL, '2019-09-14 13:14:22', '2025-07-18 22:18:42'),
...
INSERT INTO `job_categories` (`id`, `name`, `slug`, `description`, `banner`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 'ব্যাংক/নন-ব্যাংক ফিনান্সিয়াল ইনস্টিটিউশন', 'bzangknn-bzangk-finansiyal-institiusn', NULL, NULL, 1, '2025-08-09 11:22:18', '2025-08-09 11:22:18'),
(2, 'আইটি/টেলিকম/সফটওয়্যার', 'aititelikmsftwzar', NULL, NULL, 1, '2025-08-09 11:22:46', '2025-08-09 11:23:27'),
(3, 'এনজিও/ডেভেলপমেন্ট', 'enjioodevelpment', NULL, NULL, 1, '2025-08-09 11:23:19', '2025-08-09 11:23:19'),
(4, 'ফার্মাসিউটিক্যালস/কেমিক্যাল', 'farmasiutikzalskemikzal', NULL, NULL, 1, '2025-08-09 11:23:49', '2025-08-09 11:23:49'),
(5, 'গার্মেন্টস/টেক্সটাইল/জুট', 'garmentstekstailjut', NULL, NULL, 1, '2025-08-09 11:24:05', '2025-08-09 11:24:05'),
(6, 'শিক্ষা/প্রশিক্ষণ', 'sikshaprsikshn', NULL, NULL, 1, '2025-08-09 11:24:28', '2025-08-09 11:24:28'),
(7, 'মেডিকেল/হাসপাতাল/ক্লিনিক', 'medikelhaspatalklinik', NULL, NULL, 1, '2025-08-09 11:24:42', '2025-08-09 11:24:42'),
(8, 'সরকারী/আধা-সরকারী/স্বায়ত্তশাসিত', 'srkareeadha-srkareeswayttsasit', NULL, NULL, 1, '2025-08-09 11:25:00', '2025-08-09 11:25:00'),
(9, 'খাদ্য ও পানীয় শিল্প', 'khadz-oo-paneey-silp', NULL, NULL, 1, '2025-08-09 11:25:41', '2025-08-09 11:25:41'),
(10, 'পরিবহন/লজিস্টিকস', 'pribhnljistiks', NULL, NULL, 1, '2025-08-09 11:25:57', '2025-08-09 11:25:57'),
(11, 'রিয়েল এস্টেট/কনস্ট্রাকশন', 'riyel-estetknstrakshn', NULL, NULL, 1, '2025-08-09 11:26:13', '2025-08-09 11:26:13'),
(12, 'এগ্রো-ফুড/লাইভস্টক/ফিশারিজ', 'egro-fudlaivstkfisarij', NULL, NULL, 1, '2025-08-09 11:26:46', '2025-08-09 11:26:46'),
(13, 'আইন/লিগ্যাল সার্ভিস', 'ainligzal-sarvis', NULL, NULL, 1, '2025-08-09 11:27:16', '2025-08-09 11:27:16'),
(14, 'রিটেইল/হোলসেল/এক্সপোর্ট-ইমপোর্ট', 'riteilholseleksport-import', NULL, NULL, 1, '2025-08-09 11:27:33', '2025-08-09 11:27:33'),
(15, 'এনার্জি/পাওয়ার/ফুয়েল', 'enarjipawarfuyel', NULL, NULL, 1, '2025-08-09 11:27:48', '2025-08-09 11:27:48'),
(16, 'নিরাপত্তা/সিকিউরিটি সার্ভিস', 'nirapttasikiuriti-sarvis', NULL, NULL, 1, '2025-08-09 11:28:03', '2025-08-09 11:28:03'),
(17, 'রিসার্চ ও কনসালটেন্সি', 'risarc-oo-knsaltensi', NULL, NULL, 1, '2025-08-09 11:28:14', '2025-08-09 11:36:38');
...
CREATE TABLE `job_posts` (
  ...
  `work_mode` enum('Office','Remote','Hybrid') NOT NULL DEFAULT 'Office',
  `experience_required` int(11) NOT NULL DEFAULT 0 COMMENT 'in years',
...
INSERT INTO `job_posts` (`id`, `employer_id`, `job_category_id`, `title`, `location`, `job_type`, `work_mode`, `experience_required`, `salary`, `currency`, `published_at`, `deadline`, `short_description`, `full_description`, `skills`, `education`, `gender_preference`, `vacancies`, `status`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 'Relationship Manager – Retail Banking', 'Dhaka', 'Full Time', 'Office', 0, 250000.00, 'BDT', '2025-08-06', '2025-08-30', 'We are seeking a motivated and customer-focused Relationship Manager to join our retail banking team.', '<p data-start=\"334\" data-end=\"585\"><strong data-start=\"587\" data-end=\"612\">Key Responsibilities:</strong></p>\r\n<ul data-start=\"615\" data-end=\"788\">\r\n<li data-start=\"615\" data-end=\"661\">\r\n<p data-start=\"617\" data-end=\"661\">Develop and maintain client relationships.</p>\r\n</li>\r\n<li data-start=\"662\" data-end=\"704\">\r\n<p data-start=\"664\" data-end=\"704\">Promote banking products and services.</p>\r\n</li>\r\n<li data-start=\"705\" data-end=\"740\">\r\n<p data-start=\"707\" data-end=\"740\">Meet sales and service targets.</p>\r\n</li>\r\n<li data-start=\"741\" data-end=\"788\">\r\n<p data-start=\"743\" data-end=\"788\">Ensure compliance with banking regulations.</p>\r\n</li>\r\n</ul>\r\n<p data-start=\"790\" data-end=\"809\"><strong data-start=\"790\" data-end=\"807\">Requirements:</strong></p>\r\n<ul data-start=\"810\" data-end=\"981\">\r\n<li data-start=\"810\" data-end=\"871\">\r\n<p data-start=\"812\" data-end=\"871\">Bachelor’s degree in Finance, Business, or related field.</p>\r\n</li>\r\n<li data-start=\"872\" data-end=\"932\">\r\n<p data-start=\"874\" data-end=\"932\">2+ years of experience in banking or financial services.</p>\r\n</li>\r\n<li data-start=\"933\" data-end=\"981\">\r\n<p data-start=\"935\" data-end=\"981\">Strong communication and negotiation skills.</p>\r\n</li>\r\n</ul>\r\n<p data-start=\"983\" data-end=\"998\"><strong data-start=\"983\" data-end=\"996\">Benefits:</strong></p>\r\n<ul data-start=\"999\" data-end=\"1112\">\r\n<li data-start=\"999\" data-end=\"1037\">\r\n<p data-start=\"1001\" data-end=\"1037\">Competitive salary and incentives.</p>\r\n</li>\r\n<li data-start=\"1038\" data-end=\"1079\">\r\n<p data-start=\"1040\" data-end=\"1079\">Health insurance and retirement plan.</p>\r\n</li>\r\n<li data-start=\"1080\" data-end=\"1112\">\r\n<p data-start=\"1082\" data-end=\"1112\">Career growth opportunities.</p></li></ul>', '\"[\\\"Strong communication, negotiation skills.\\\"]\"', 'Bachelor’s degree in Finance, Business, or related field.', 'NO', 10, 'published', '2025-08-09 11:40:04', '2025-08-09 11:40:16'),
(2, 1, 2, 'IT Support Specialist', 'Dhaka', 'Full Time', 'Office', 3, 45000.00, 'BDT', '2025-08-03', '2025-08-14', 'We are looking for an experienced IT Support Specialist to maintain our technology infrastructure and assist end-users with technical issues.', '<p data-start=\"1414\" data-end=\"1441\"><strong data-start=\"1414\" data-end=\"1439\">Key Responsibilities:</strong></p>\r\n<ul data-start=\"1442\" data-end=\"1632\">\r\n<li data-start=\"1442\" data-end=\"1501\">\r\n<p data-start=\"1444\" data-end=\"1501\">Install, configure, and maintain hardware and software.</p>\r\n</li>\r\n<li data-start=\"1502\" data-end=\"1548\">\r\n<p data-start=\"1504\" data-end=\"1548\">Troubleshoot technical problems for staff.</p>\r\n</li>\r\n<li data-start=\"1549\" data-end=\"1587\">\r\n<p data-start=\"1551\" data-end=\"1587\">Manage system backups and updates.</p>\r\n</li>\r\n<li data-start=\"1588\" data-end=\"1632\">\r\n<p data-start=\"1590\" data-end=\"1632\">Ensure network security and performance.</p>\r\n</li>\r\n</ul>\r\n<p data-start=\"1634\" data-end=\"1653\"><strong data-start=\"1634\" data-end=\"1651\">Requirements:</strong></p>\r\n<ul data-start=\"1654\" data-end=\"1797\">\r\n<li data-start=\"1654\" data-end=\"1712\">\r\n<p data-start=\"1656\" data-end=\"1712\">Bachelor’s in Information Technology or related field.</p>\r\n</li>\r\n<li data-start=\"1713\" data-end=\"1752\">\r\n<p data-start=\"1715\" data-end=\"1752\">1–3 years of IT support experience.</p>\r\n</li>\r\n<li data-start=\"1753\" data-end=\"1797\">\r\n<p data-start=\"1755\" data-end=\"1797\">Knowledge of Windows/Linux environments.</p>\r\n</li>\r\n</ul>\r\n<p data-start=\"1799\" data-end=\"1814\"><strong data-start=\"1799\" data-end=\"1812\">Benefits:</strong></p>\r\n<ul data-start=\"1815\" data-end=\"1918\">\r\n<li data-start=\"1815\" data-end=\"1838\">\r\n<p data-start=\"1817\" data-end=\"1838\">Competitive salary.</p>\r\n</li>\r\n<li data-start=\"1839\" data-end=\"1884\">\r\n<p data-start=\"1841\" data-end=\"1884\">Training and certification opportunities.</p>\r\n</li>\r\n<li data-start=\"1885\" data-end=\"1918\">\r\n<p data-start=\"1887\" data-end=\"1918\">Health and wellness benefits.</p>\r\n</li>\r\n</ul>', '\"[\\\"nowledge of Windows\\\\\\/Linux environments.\\\"]\"', 'Bachelor’s in Information Technology or related field.', 'NO', 2, 'published', '2025-08-09 11:54:54', '2025-08-09 11:57:08'),
(3, 1, 2, 'Full-Stack Web Developer', 'Dhaka', 'Full Time', 'Remote', 2, 500000.00, 'BDT', '2025-08-07', '2025-08-21', 'We are hiring a skilled Full-Stack Developer to design, develop, and maintain high-quality web applications.', '<p data-start=\"2206\" data-end=\"2233\"><strong data-start=\"2206\" data-end=\"2231\">Key Responsibilities:</strong></p>\r\n<ul data-start=\"2234\" data-end=\"2405\">\r\n<li data-start=\"2234\" data-end=\"2278\">\r\n<p data-start=\"2236\" data-end=\"2278\">Develop responsive front-end interfaces.</p>\r\n</li>\r\n<li data-start=\"2279\" data-end=\"2316\">\r\n<p data-start=\"2281\" data-end=\"2316\">Build and maintain back-end APIs.</p>\r\n</li>\r\n<li data-start=\"2317\" data-end=\"2369\">\r\n<p data-start=\"2319\" data-end=\"2369\">Collaborate with designers and project managers.</p>\r\n</li>\r\n<li data-start=\"2370\" data-end=\"2405\">\r\n<p data-start=\"2372\" data-end=\"2405\">Write clean, maintainable code.</p>\r\n</li>\r\n</ul>\r\n<p data-start=\"2407\" data-end=\"2426\"><strong data-start=\"2407\" data-end=\"2424\">Requirements:</strong></p>\r\n<ul data-start=\"2427\" data-end=\"2602\">\r\n<li data-start=\"2427\" data-end=\"2487\">\r\n<p data-start=\"2429\" data-end=\"2487\">Bachelor’s in Computer Science or equivalent experience.</p>\r\n</li>\r\n<li data-start=\"2488\" data-end=\"2545\">\r\n<p data-start=\"2490\" data-end=\"2545\">Proficiency in HTML, CSS, JavaScript, and Python/PHP.</p>\r\n</li>\r\n<li data-start=\"2546\" data-end=\"2602\">\r\n<p data-start=\"2548\" data-end=\"2602\">Experience with frameworks (React, Django, Laravel).</p>\r\n</li>\r\n</ul>\r\n<p data-start=\"2604\" data-end=\"2619\"><strong data-start=\"2604\" data-end=\"2617\">Benefits:</strong></p>\r\n<ul data-start=\"2620\" data-end=\"2716\">\r\n<li data-start=\"2620\" data-end=\"2647\">\r\n<p data-start=\"2622\" data-end=\"2647\">Flexible working hours.</p>\r\n</li>\r\n<li data-start=\"2648\" data-end=\"2672\">\r\n<p data-start=\"2650\" data-end=\"2672\">Performance bonuses.</p>\r\n</li>\r\n<li data-start=\"2673\" data-end=\"2716\">\r\n<p data-start=\"2675\" data-end=\"2716\">Professional development opportunities.</p></li></ul>', '\"[\\\"HTML, CSS, JavaScript,Python\\\\\\/PHP.\\\"]\"', 'Bachelor’s in Computer Science or equivalent experience.', 'NO', 1, 'published', '2025-08-09 11:56:57', '2025-08-09 11:57:11');
...
(4, '2025_07_20_234014_create_chapters_table', 1),
(5, '2025_07_20_234049_create_topics_table', 1),
(6, '2025_07_21_000722_create_category_subject_table', 1),
(7, '2025_07_24_234740_create_question_banks_table', 2),
(8, '2025_07_24_235509_create_questions_table', 3),
(9, '2025_07_24_235842_create_question_topic_table', 3),
(10, '2025_07_24_235845_create_question_chapter_table', 3),
(11, '2025_07_24_235848_create_question_question_bank_table', 3),
(12, '2025_08_03_010700_create_employers_table', 4),
(13, '2025_08_03_010850_create_job_categories_table', 4),
(14, '2025_08_03_010946_create_job_posts_table', 4),
(15, '2025_08_03_011518_create_applications_table', 4);
...
INSERT INTO `options` (`id`, `question_id`, `option`, `correct_ans`, `created_at`, `updated_at`) VALUES
(1, 1, 'Oracle', 1, '2025-07-18 22:24:17', '2025-07-18 22:24:17'),
(2, 1, 'McAfee', 0, '2025-07-18 22:24:17', '2025-07-18 22:24:17'),
(3, 1, 'Norton', 0, '2025-07-18 22:24:17', '2025-07-18 22:24:17'),
(4, 1, 'Kaspersky', 0, '2025-07-18 22:24:17', '2025-07-18 22:24:17'),
(5, 2, 'Random Frequency Identification', 0, '2025-07-18 22:25:25', '2025-07-18 22:25:25'),
(6, 2, 'Random Frequency Information', 0, '2025-07-18 22:25:25', '2025-07-18 22:25:25'),
(7, 2, 'Radio Frequency Information', 0, '2025-07-18 22:25:25', '2025-07-18 22:25:25'),
(8, 2, 'Radio Frequency Identification', 1, '2025-07-18 22:25:25', '2025-07-18 22:25:25'),
(9, 3, 'monitor', 0, '2025-07-18 22:26:10', '2025-07-18 22:26:10'),
(10, 3, 'microphone', 1, '2025-07-18 22:26:10', '2025-07-18 22:26:10'),
(11, 3, 'printer', 0, '2025-07-18 22:26:10', '2025-07-18 22:26:10'),
(12, 3, 'speaker', 0, '2025-07-18 22:26:10', '2025-07-18 22:26:10'),
(13, 4, 'Internet of Things (IoT)', 0, '2025-07-18 22:26:57', '2025-07-18 22:26:57'),
(14, 4, 'Cloud Computing', 1, '2025-07-18 22:26:57', '2025-07-18 22:26:57'),
(15, 4, 'Client-Server Systems', 0, '2025-07-18 22:26:57', '2025-07-18 22:26:57'),
(16, 4, 'Big Data Analysis', 0, '2025-07-18 22:26:57', '2025-07-18 22:26:57'),
(17, 5, 'ঢাকা', 1, '2025-07-19 11:19:12', '2025-07-19 11:19:12'),
(18, 5, 'কুমিল্লা', 0, '2025-07-19 11:19:12', '2025-07-19 11:19:12'),
(19, 5, 'দিল্লি', 0, '2025-07-19 11:19:12', '2025-07-19 11:19:12'),
(20, 5, 'মোহাম্মাদপুর', 0, '2025-07-19 11:19:12', '2025-07-19 11:19:12');
...
(28, 'Blog', 'post', 'templates.basic.', '[\"blog\"]', NULL, 0, '2025-07-30 16:45:36', '2025-07-30 16:46:09');
...
INSERT INTO `questions` (`id`, `question_text`, `options`, `correct_answer`, `explanation`, `status`, `created_at`, `updated_at`) VALUES
(1, '\"আনারস\" এবং \"চাবি\" শব্দ দুটি বাংলা ভাষা গ্রহণ করেছে', '\"[\\\"\\\\u09aa\\\\u09b0\\\\u09cd\\\\u09a4\\\\u09c1\\\\u0997\\\\u09bf\\\\u099c \\\\u09ad\\\\u09be\\\\u09b7\\\\u09be \\\\u09a5\\\\u09c7\\\\u0995\\\\u09c7\\\",\\\"\\\\u0986\\\\u09b0\\\\u09ac\\\\u09bf \\\\u09ad\\\\u09be\\\\u09b7\\\\u09be \\\\u09a5\\\\u09c7\\\\u0995\\\\u09c7\\\",\\\"\\\\u09a6\\\\u09c7\\\\u09b6\\\\u09c0 \\\\u09ad\\\\u09be\\\\u09b7\\\\u09be \\\\u09a5\\\\u09c7\\\\u0995\\\\u09c7\\\",\\\"\\\\u0993\\\\u09b2\\\\u09a8\\\\u09cd\\\\u09a6\\\\u09be\\\\u099c \\\\u09ad\\\\u09be\\\\u09b7\\\\u09be \\\\u09a5\\\\u09c7\\\\u0995\\\\u09c7\\\"]\"', '\"[0]\"', '<br>', 1, '2025-07-27 00:42:33', '2025-07-27 00:42:33'),
(2, 'তৎসম ও দেশীয় শব্দ একসঙ্গে ব্যবহারে কোন ধরনের ভাষাগত দোষ হয়?', '\"[\\\"\\\\u09ac\\\\u09be\\\\u0995\\\\u09cd\\\\u09af\\\\u09ac\\\\u09bf\\\\u099a\\\\u09cd\\\\u099b\\\\u09c7\\\\u09a6\\\\u09c7\\\\u09b0 \\\\u09a6\\\\u09cb\\\\u09b7\\\",\\\"\\\\u0997\\\\u09c1\\\\u09b0\\\\u09c1\\\\u099a\\\\u09a3\\\\u09cd\\\\u09a1\\\\u09be\\\\u09b2\\\\u09c0 \\\\u09a6\\\\u09cb\\\\u09b7\\\",\\\"\\\\u0985\\\\u09a7\\\\u09bf\\\\u0995\\\\u09be\\\\u09b6\\\\u09cd\\\\u09b0\\\\u09df\\\\u09a4\\\\u09be \\\\u09a6\\\\u09cb\\\\u09b7\\\",\\\"\\\\u09a7\\\\u09cd\\\\u09ac\\\\u09a8\\\\u09bf\\\\u09ac\\\\u09c8\\\\u09b7\\\\u09ae\\\\u09cd\\\\u09af\\\\u09c7\\\\u09b0 \\\\u09a6\\\\u09cb\\\\u09b7\\\"]\"', '\"[1]\"', '<div><font color=\"#ffffff\" face=\"Source Sans Pro, Helvetica Neue, Helvetica, Arial, sans-serif\"><span style=\"font-size: 14px;\">- তৎসম শব্দের সঙ্গে দেশীয় শব্দের প্রয়োগ কখনো কখনো গুরুচণ্ডালী দোষ সৃষ্টি করে। এ দোষে দুষ্ট শব্দ তার যোগ্যতা হারায় ।</span></font></div><div><font color=\"#ffffff\" face=\"Source Sans Pro, Helvetica Neue, Helvetica, Arial, sans-serif\"><span style=\"font-size: 14px;\">- যেমন গরুর গাড়ি, শব্দাহ, মড়াপোড়া প্রকৃতির স্থলে যথাক্রমে গরুর শকট, মড়াদাহ প্রভৃতি প্রয়োগ গুরুচন্ডালী দোষ সৃষ্টি করে। গুরুচণ্ডালী দোষ মুক্ত শব্দ শবদাহ।</span></font></div>', 1, '2025-07-27 00:57:35', '2025-07-27 00:57:35'),
(3, 'নিচের কোন বাক্যে ‘অহংকার’ অর্থে ‘গরম’ শব্দটি ব্যবহৃত হয়েছে?', '\"[\\\"\\\\u09b6\\\\u09bf\\\\u0995\\\\u09cd\\\\u09b7\\\\u0995\\\\u09c7\\\\u09b0 \\\\u09ae\\\\u09c7\\\\u099c\\\\u09be\\\\u099c \\\\u0997\\\\u09b0\\\\u09ae \\\\u0995\\\\u09be\\\\u09b0\\\\u09a3 \\\\u0995\\\\u09c7\\\\u0989 \\\\u09a4\\\\u09be\\\\u09b0 \\\\u0995\\\\u09a5\\\\u09be \\\\u09ae\\\\u09a8 \\\\u09a6\\\\u09bf\\\\u09df\\\\u09c7 \\\\u09b6\\\\u09cb\\\\u09a8\\\\u09c7 \\\\u09a8\\\\u09be\\\\u0964\\\",\\\"\\\\u09a6\\\\u09c1 \\\\u09a8\\\\u09ae\\\\u09cd\\\\u09ac\\\\u09b0\\\\u09bf \\\\u099f\\\\u09be\\\\u0995\\\\u09be\\\\u09b0 \\\\u0997\\\\u09b0\\\\u09ae\\\\u09c7 \\\\u09b0\\\\u09b9\\\\u09bf\\\\u09ae\\\\u09c7\\\\u09b0 \\\\u09aa\\\\u09be \\\\u09af\\\\u09c7\\\\u09a8\\\\u09cb \\\\u09ae\\\\u09be\\\\u099f\\\\u09bf\\\\u09a4\\\\u09c7 \\\\u09aa\\\\u09b0\\\\u09c7 \\\\u09a8\\\\u09be\\\\u0964\\\",\\\"\\\\u0997\\\\u09b0\\\\u09ae \\\\u0986\\\\u09ac\\\\u09b9\\\\u09be\\\\u0993\\\\u09df\\\\u09be\\\\u09b0 \\\\u099c\\\\u09a8\\\\u09cd\\\\u09af \\\\u09b2\\\\u09cb\\\\u0995\\\\u09c7\\\\u09b0\\\\u09be \\\\u099b\\\\u09be\\\\u09a4\\\\u09be \\\\u09a8\\\\u09bf\\\\u09df\\\\u09c7 \\\\u0998\\\\u09b0 \\\\u09a5\\\\u09c7\\\\u0995\\\\u09c7 \\\\u09ac\\\\u09c7\\\\u09b0 \\\\u09b9\\\\u09df\\\\u0964\\\",\\\"\\\\u09a4\\\\u09be\\\\u09b0 \\\\u0997\\\\u09b0\\\\u09ae \\\\u0997\\\\u09be\\\\u09df\\\\u09c7 \\\\u0995\\\\u09c7\\\\u0989 \\\\u099c\\\\u09b2 \\\\u09a2\\\\u09be\\\\u09b2\\\\u09a4\\\\u09c7 \\\\u09b8\\\\u09be\\\\u09b9\\\\u09b8 \\\\u09aa\\\\u09be\\\\u09df \\\\u09a8\\\\u09be\\\\u0964\\\"]\"', '\"[1]\"', NULL, 1, '2025-07-27 00:57:35', '2025-07-27 00:57:35'),
(4, 'নিচের কোন শব্দে মূর্ধন্য-ণ এর প্রয়োগ ভুল হয়েছে?', '\"[\\\"\\\\u09a6\\\\u09c1\\\\u09b0\\\\u09cd\\\\u09a3\\\\u09c0\\\\u09a4\\\\u09c0\\\",\\\"\\\\u09a6\\\\u09c1\\\\u09b0\\\\u09cd\\\\u09a3\\\\u09be\\\\u09ae\\\",\\\"\\\\u0985\\\\u09a3\\\\u09c1\\\\u0997\\\\u09cd\\\\u09b0\\\\u09b9\\\",\\\"\\\\u0995\\\\u09b0\\\\u09cd\\\\u09a3\\\\u09ab\\\\u09c1\\\\u09b2\\\\u09c0\\\"]\"', '\"[1]\"', NULL, 1, '2025-07-27 00:57:35', '2025-07-27 00:57:35'),
(5, 'নিচের কোন বাক্যটি প্রয়ােগগত দিক থেকে শুদ্ধ?', '\"[\\\"\\\\u0986\\\\u09ae\\\\u09bf \\\\u0995\\\\u09be\\\\u09b0\\\\u0993 \\\\u09b8\\\\u09be\\\\u09a4\\\\u09c7\\\\u0993 \\\\u09a8\\\\u09c7\\\\u0987, \\\\u09b8\\\\u09a4\\\\u09c7\\\\u09b0\\\\u09be\\\\u09c7\\\\u09a4\\\\u09c7\\\\u0993 \\\\u09a8\\\\u09c7\\\\u0987\\\\u0964\\\",\\\"\\\\u0986\\\\u09aa\\\\u09a8\\\\u09bf \\\\u09b8\\\\u09cd\\\\u09ac\\\\u09aa\\\\u09b0\\\\u09bf\\\\u09ac\\\\u09be\\\\u09b0\\\\u09c7 \\\\u0986\\\\u09ae\\\\u09a8\\\\u09cd\\\\u09a4\\\\u09cd\\\\u09b0\\\\u09bf\\\\u09a4\\\\u0964\\\",\\\"\\\\u09a4\\\\u09be\\\\u09b0 \\\\u09a6\\\\u09c1\'\\\\u099a\\\\u09cb\\\\u0996 \\\\u0985\\\\u09b6\\\\u09cd\\\\u09b0\\\\u09c1\\\\u09a4\\\\u09c7 \\\\u09ad\\\\u09c7\\\\u09b8\\\\u09c7 \\\\u0997\\\\u09c7\\\\u09b2\\\\u0964\\\",\\\"\\\\u09b8\\\\u09be\\\\u09b0\\\\u09be \\\\u099c\\\\u09c0\\\\u09ac\\\\u09a8 \\\\u09ad\\\\u09c2\\\\u09a4\\\\u09c7\\\\u09b0 \\\\u09ae\\\\u099c\\\\u09c1\\\\u09b0\\\\u09bf \\\\u0996\\\\u09c7\\\\u099f\\\\u09c7 \\\\u09ae\\\\u09b0\\\\u09b2\\\\u09be\\\\u09ae \\\\u0964\\\"]\"', '\"[2]\"', NULL, 1, '2025-07-27 00:57:35', '2025-07-27 00:57:35'),
(6, 'নিচের কোনটি প্রত্যয়-ঘটিত অপপ্রয়োগ?', '\"[\\\"\\\\u09aa\\\\u09be\\\\u09ac\\\\u09b0\\\\u09cd\\\\u09a4\\\\u09cd\\\\u09af \\\\u0985\\\\u099e\\\\u09cd\\\\u099a\\\\u09b2\\\\u09c7 \\\\u0989\\\\u09aa\\\\u099c\\\\u09be\\\\u09a4\\\\u09bf\\\\u09b0\\\\u09be \\\\u09b8\\\\u09cd\\\\u09ac\\\\u09be\\\\u09df\\\\u09a4\\\\u09cd\\\\u09a4\\\\u09b6\\\\u09be\\\\u09b8\\\\u09a8 \\\\u099a\\\\u09be\\\\u09df\\\",\\\"\\\\u09af\\\\u09be\\\\u09ac\\\\u09a4\\\\u09c0\\\\u09df \\\\u09ac\\\\u09bf\\\\u09b7\\\\u09df\\\\u09be\\\\u09a6\\\\u09bf \\\\u09ae\\\\u09a8\\\\u09cd\\\\u09a4\\\\u09cd\\\\u09b0\\\\u09bf\\\\u09ae\\\\u09b9\\\\u09cb\\\\u09a6\\\\u09df \\\\u09a6\\\\u09c7\\\\u0996\\\\u09ad\\\\u09be\\\\u09b2 \\\\u0995\\\\u09b0\\\\u09c7\\\\u09a8\\\",\\\"\\\\u09a4\\\\u09be\\\\u09b0 \\\\u09b8\\\\u09be\\\\u09a5\\\\u09c7 \\\\u09ac\\\\u09c7\\\\u09b6 \\\\u09b8\\\\u0996\\\\u09cd\\\\u09af \\\\u09b9\\\\u09df\\\\u09c7\\\\u099b\\\\u09c7\\\",\\\"\\\\u0995\\\\u09cb\\\\u09a8\\\\u09cb\\\\u099f\\\\u09bf\\\\u0987 \\\\u09a8\\\\u09df\\\"]\"', '\"[1]\"', NULL, 1, '2025-07-27 00:57:35', '2025-07-27 00:57:35'),
(7, 'বিশেষণের সাথে দুইবার প্রত্যয় যোগ করার কারণে অপপ্রয়োগ ঘটেছে কোন শব্দে?', '\"[\\\"\\\\u099a\\\\u09be\\\\u09aa\\\\u09b2\\\\u09cd\\\\u09af\\\",\\\"\\\\u09a6\\\\u09be\\\\u09b0\\\\u09bf\\\\u09a6\\\\u09cd\\\\u09b0\\\\u09cd\\\\u09af\\\\u09a4\\\\u09be\\\",\\\"\\\\u099a\\\\u09a4\\\\u09c1\\\\u09b0\\\\u09a4\\\\u09be\\\",\\\"\\\\u0995\\\\u09be\\\\u09b0\\\\u09cd\\\\u09aa\\\\u09a3\\\\u09cd\\\\u09af\\\"]\"', '\"[1]\"', NULL, 1, '2025-07-27 00:57:36', '2025-07-27 00:57:36');
...
INSERT INTO `question_banks` (`id`, `category_id`, `name`, `year`, `created_by`, `updated_by`, `status`, `created_at`, `updated_at`) VALUES
(1, 3, '45th BCS', '2024', 1, NULL, 1, '2025-07-27 00:50:32', '2025-07-27 00:50:32'),
(2, 3, '46th BCS', '2025', 1, NULL, 1, '2025-07-27 00:50:50', '2025-07-27 00:50:50');

-- --------------------------------------------------------

--
-- Table structure for table `question_chapter`
--
...
--
-- Table structure for table `question_question_bank`
--
...
--
-- Dumping data for table `question_question_bank`
--

INSERT INTO `question_question_bank` (`id`, `question_id`, `question_bank_id`, `created_by`, `created_at`, `updated_at`) VALUES
(1, 2, 1, NULL, '2025-07-27 00:57:35', '2025-07-27 00:57:35'),
(2, 3, 1, NULL, '2025-07-27 00:57:35', '2025-07-27 00:57:35'),
(3, 4, 1, NULL, '2025-07-27 00:57:35', '2025-07-27 00:57:35'),
(4, 5, 1, NULL, '2025-07-27 00:57:35', '2025-07-27 00:57:35'),
(5, 6, 1, NULL, '2025-07-27 00:57:36', '2025-07-27 00:57:36'),
(6, 7, 1, NULL, '2025-07-27 00:57:36', '2025-07-27 00:57:36');
...
INSERT INTO `question_topic` (`id`, `question_id`, `topic_id`, `created_by`, `created_at`, `updated_at`) VALUES
(1, 1, 1, NULL, '2025-07-27 00:42:33', '2025-07-27 00:42:33'),
(2, 2, 2, NULL, '2025-07-27 00:57:35', '2025-07-27 00:57:35'),
(3, 3, 2, NULL, '2025-07-27 00:57:35', '2025-07-27 00:57:35'),
(4, 4, 2, NULL, '2025-07-27 00:57:35', '2025-07-27 00:57:35'),
(5, 5, 2, NULL, '2025-07-27 00:57:35', '2025-07-27 00:57:35'),
(6, 6, 2, NULL, '2025-07-27 00:57:35', '2025-07-27 00:57:35'),
(7, 7, 2, NULL, '2025-07-27 00:57:36', '2025-07-27 00:57:36');
...
INSERT INTO `results` (`id`, `user_id`, `exam_id`, `result_mark`, `total_correct_ans`, `total_wrong_ans`, `result_status`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 199.00, 3, 1, 1, '2025-07-18 22:30:38', '2025-07-18 22:31:23'),
(2, 2, 1, 196.00, 1, 4, 1, '2025-07-20 18:14:04', '2025-07-20 18:14:27');
...
(1, 1, '45th BCS', '45th-bcs', '45th BCS Question Bank', 1, 1, '2025-07-18 16:16:24', '2025-07-18 16:16:24'),
(2, 2, 'Bangla', 'bangla', 'sdlkf', 1, 1, '2025-07-19 11:17:18', '2025-07-19 11:17:18'),
(3, 0, 'Math', 'math', 'গাণিতিক যুক্তি', 1, 1, '2025-07-22 11:40:22', '2025-07-22 11:40:22');
...
INSERT INTO `topics` (`id`, `chapter_id`, `title`, `content`, `banner`, `status`, `created_at`, `updated_at`) VALUES
(1, 1, 'বাক্য', NULL, NULL, 1, '2025-07-22 11:42:12', '2025-07-22 11:42:12'),
(2, 2, 'প্রয়োগ-অপপ্রয়োগ', NULL, NULL, 1, '2025-07-26 17:54:53', '2025-07-26 17:54:53');
...
(1, 1, 0.00000000, 0.00000000, 0.00000000, '-', '5DVVUJPK77WR', 'Payment of exam fee, 45 BCS Exam Question', 'exam_fee', '2025-07-18 22:30:37', '2025-07-18 22:30:37');
...
INSERT INTO `users` (`id`, `firstname`, `lastname`, `username`, `email`, `cv`, `dial_code`, `mobile`, `balance`, `password`, `image`, `country_name`, `country_code`, `city`, `state`, `zip`, `address`, `status`, `kyc_data`, `kyc_rejection_reason`, `kv`, `ev`, `sv`, `profile_complete`, `ver_code`, `ver_code_send_at`, `ts`, `tv`, `tsc`, `ban_reason`, `remember_token`, `provider`, `provider_id`, `created_at`, `updated_at`) VALUES
(1, 'Md. Moniruzzaman', 'Moon', 'moniruzzaman', 'moon.mn717@gmail.com', NULL, '880', '1761189963', 0.00000000, '$2y$12$FSA9hdSWTqIJrvhV5.9RjOnj6oZLGWPqkpzb2s5VVbIxjzwg3x5HK', NULL, 'Bangladesh', 'BD', 'Dhaka', 'Bangladesh', '1215', 'Uttar Badda', 1, NULL, NULL, 1, 1, 1, 1, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, '2025-07-18 22:28:15', '2025-07-18 22:30:37'),
(2, 'Al-Tasnimul', 'Tushar', 'tushar', 'tasnimtushar6@gmail.com', NULL, '880', '01943231512', 0.00000000, '$2y$12$nBMryGpBYWJhhjtMQv9Lke/88QcN9Quz4Z.DOMXZ6oR7Yt.eCB9uK', NULL, 'Bangladesh', 'BD', 'Dhaka', NULL, '1207', '32/A, Jafrabad, Sher-e-bangla Road, Rayer Bazar.', 1, NULL, NULL, 1, 1, 1, 1, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, '2025-07-20 18:10:59', '2025-07-20 18:11:48'),
(3, 'borhan', 'uddin', 'borhan', 'atifborhan@gmail.com', NULL, '880', '01681159983', 0.00000000, '$2y$12$uIXSCDmZnHdEYYazqqlRG.3P495pNhnm.zctgP6NBWbyi5.So3dQy', NULL, 'Bangladesh', 'BD', 'Dhaka, Bangladesh', 'dhaka', '1215', '140 green road farmgate, Dhaka 1215', 1, NULL, NULL, 1, 1, 1, 1, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, '2025-07-22 17:13:22', '2025-07-22 17:15:05');
...
(1, 1, '103.102.27.2', '', 'Bangladesh', 'BD', '90.3742', '23.7018', 'Chrome', 'Windows 10', '2025-07-18 22:28:16', '2025-07-18 22:28:16'),
(2, 2, '104.28.164.37', 'Santa Cruz', 'India', 'IN', '72.8278', '19.0812', 'Chrome', 'Windows 10', '2025-07-20 18:11:00', '2025-07-20 18:11:00'),
(3, 3, '103.144.201.8', 'Dhaka', 'Bangladesh', 'BD', '90.4135', '23.7278', 'Chrome', 'Windows 10', '2025-07-22 17:13:22', '2025-07-22 17:13:22');
...
ALTER TABLE `category_subject`
  ADD PRIMARY KEY (`category_id`,`subject_id`),
  ADD KEY `category_subject_subject_id_foreign` (`subject_id`);
...
ALTER TABLE `employers`
  ...
  ADD UNIQUE KEY `employers_user_name_unique` (`user_name`);
...
ALTER TABLE `question_banks`
  ADD PRIMARY KEY (`id`),
  ADD KEY `question_banks_category_id_foreign` (`category_id`),
  ADD KEY `question_banks_created_by_foreign` (`created_by`),
  ADD KEY `question_banks_updated_by_foreign` (`updated_by`);

--
-- Indexes for table `question_chapter`
--
ALTER TABLE `question_chapter`
  ADD PRIMARY KEY (`id`),
  ADD KEY `question_chapter_question_id_foreign` (`question_id`),
  ADD KEY `question_chapter_chapter_id_foreign` (`chapter_id`),
  ADD KEY `question_chapter_created_by_foreign` (`created_by`);

--
-- Indexes for table `question_question_bank`
--
ALTER TABLE `question_question_bank`
  ADD PRIMARY KEY (`id`),
  ADD KEY `question_question_bank_question_id_foreign` (`question_id`),
  ADD KEY `question_question_bank_question_bank_id_foreign` (`question_bank_id`),
  ADD KEY `question_question_bank_created_by_foreign` (`created_by`);
...
ALTER TABLE `question_topic`
  ...
  ADD KEY `question_topic_created_by_foreign` (`created_by`);
...
--
-- AUTO_INCREMENT for table `question_chapter`
--
ALTER TABLE `question_chapter`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `question_question_bank`
--
ALTER TABLE `question_question_bank`
...
--
ALTER TABLE `category_subject`
  ADD CONSTRAINT `category_subject_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `category_subject_subject_id_foreign` FOREIGN KEY (`subject_id`) REFERENCES `subjects` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `job_posts`
  ...
  ADD CONSTRAINT `job_posts_job_category_id_foreign` FOREIGN KEY (`job_category_id`) REFERENCES `job_categories` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `question_banks`
--
ALTER TABLE `question_banks`
  ADD CONSTRAINT `question_banks_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `question_banks_created_by_foreign` FOREIGN KEY (`created_by`) REFERENCES `admins` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `question_banks_updated_by_foreign` FOREIGN KEY (`updated_by`) REFERENCES `admins` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `question_chapter`
--
ALTER TABLE `question_chapter`
  ADD CONSTRAINT `question_chapter_chapter_id_foreign` FOREIGN KEY (`chapter_id`) REFERENCES `chapters` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `question_chapter_created_by_foreign` FOREIGN KEY (`created_by`) REFERENCES `admins` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `question_chapter_question_id_foreign` FOREIGN KEY (`question_id`) REFERENCES `questions` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `question_question_bank`
--
ALTER TABLE `question_question_bank`
  ADD CONSTRAINT `question_question_bank_created_by_foreign` FOREIGN KEY (`created_by`) REFERENCES `admins` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `question_question_bank_question_bank_id_foreign` FOREIGN KEY (`question_bank_id`) REFERENCES `question_banks` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `question_question_bank_question_id_foreign` FOREIGN KEY (`question_id`) REFERENCES `questions` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `question_topic`
--
ALTER TABLE `question_topic`
  ADD CONSTRAINT `question_topic_created_by_foreign` FOREIGN KEY (`created_by`) REFERENCES `admins` (`id`) ON DELETE SET NULL,
